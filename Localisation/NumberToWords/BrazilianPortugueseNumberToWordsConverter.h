#ifndef _BrazilianPortugueseNumberToWordsConverter_h_
#define _BrazilianPortugueseNumberToWordsConverter_h_
...
}#endif // _BrazilianPortugueseNumberToWordsConverter_h_
